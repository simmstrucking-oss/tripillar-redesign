    ...
    <div style={{ marginBottom: 10 }}>
      ...
      {expanded && logs !== null && (
        <div style={{ border: `1px solid ${C.gold}`, borderTop: 'none', borderRadius: '0 0 7px 7px',
          ...
          {/* QR Pack link for this specific cohort — inside expand panel */}
          <div style={{ marginBottom: '1.25rem', padding: '0.75rem 1rem',
            background: '#F5F0E8', borderRadius: 8, border: '1px solid #D4B896',
            display: 'flex', flexWrap: 'wrap', gap: '0.75rem', alignItems: 'center' }}>
            <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.83rem', fontWeight: 600,
              color: '#1a2f4a' }}>QR Pack for this cohort:</span>
