      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="font-serif text-2xl font-bold text-navy">Solo Companion</h1>
            <p className="text-muted text-sm mt-1">Continue your grief support journey.</p>
          </div>
          ...
          <p className="text-center text-xs text-muted mt-6">
            New to the Solo Companion?{' '}
            <a href="https://solo.tripillarstudio.com/gate"
