...
const REASON_MESSAGES: Record<string, string> = {
  ...
  role:    'You do not have organization access.',
};
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="font-serif text-2xl font-bold text-navy">Partner Portal</h1>
            <p className="text-muted text-sm mt-1">Licensed Organizations.</p>
          </div>
