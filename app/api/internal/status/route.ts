...
const LIVE_FEATURES = [
  ...
  { feature: 'Facilitator Hub dashboard',                        url: 'https://www.tripillarstudio.com/facilitators/hub',         date: '2026-03-28' },
  ...
  { feature: 'Admin panel /admin/facilitators',                  url: 'https://www.tripillarstudio.com/admin/facilitators',       date: '2026-03-28' },
  { feature: 'Admin document library',                           url: 'https://www.tripillarstudio.com/admin/documents',          date: '2026-03-29' },
  { feature: 'Admin dashboard /admin/dashboard',                 url: 'https://www.tripillarstudio.com/admin/dashboard',          date: '2026-03-28' },
  { feature: 'Admin prospect management',                        url: 'https://www.tripillarstudio.com/admin/prospects',          date: '2026-03-29' },
  { feature: 'Admin agreements + renewals',                      url: '/admin/agreements | /admin/renewals',                  date: '2026-03-29' },
  { feature: 'Prospect landing pages (/explore/[code])',         url: 'https://www.tripillarstudio.com/explore/[code]',           date: '2026-03-29' },
  { feature: 'ILA e-signature flow',                             url: '/sign/[token]',                                        date: '2026-03-29' },
  { feature: 'Org Hub (5-tab)',                                  url: 'https://www.tripillarstudio.com/org/hub',                  date: '2026-03-29' },
  { feature: 'Trainer Tier platform (full)',                     url: 'https://www.tripillarstudio.com/trainers/hub/dashboard',   date: '2026-03-30' },
  { feature: 'Public Trainer Registry',                          url: 'https://www.tripillarstudio.com/trainers',                 date: '2026-03-30' },
  ...
  { feature: 'Memorial Wall',                                    url: 'https://www.tripillarstudio.com/memorial-wall',            date: '2026-03-29' },
  { feature: 'Free Guide page + subscribe flow',                 url: 'https://www.tripillarstudio.com/free-guide',               date: '2026-03-29' },
  { feature: 'Contact form (Resend)',                            url: 'https://www.tripillarstudio.com/contact',                  date: '2026-03-29' },
  { feature: '/start landing page',                             url: 'https://www.tripillarstudio.com/start',                    date: '2026-03-29' },
