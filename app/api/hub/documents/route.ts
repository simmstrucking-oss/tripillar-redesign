...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    program_type: 'adult',
    docs: [
      { name: 'LG_Certified_Facilitator_Reference_Guide_Book1_FINAL.docx', path: '02_FACILITATOR/CFRG/LG_Certified_Facilitator_Reference_Guide_Book1_FINAL.docx' },
      { name: 'LG_Certified_Facilitator_Reference_Guide_Book2_FINAL.docx', path: '02_FACILITATOR/CFRG/LG_Certified_Facilitator_Reference_Guide_Book2_FINAL.docx' },
      { name: 'LG_Certified_Facilitator_Reference_Guide_Book3_FINAL.docx', path: '02_FACILITATOR/CFRG/LG_Certified_Facilitator_Reference_Guide_Book3_FINAL.docx' },
      { name: 'LG_Certified_Facilitator_Reference_Guide_Book4_FINAL.docx', path: '02_FACILITATOR/CFRG/LG_Certified_Facilitator_Reference_Guide_Book4_FINAL.docx' },
    ],
  },
  {
    ...
    program_type: 'adult',
    docs: [
      { name: 'LG_Master_Facilitator_Manual_Book1_FINAL.docx', path: '02_FACILITATOR/FM/LG_Master_Facilitator_Manual_Book1_FINAL.docx', requiresBook: 1 },
      { name: 'LG_Master_Facilitator_Manual_Book2_FINAL.docx', path: '02_FACILITATOR/FM/LG_Master_Facilitator_Manual_Book2_FINAL.docx', requiresBook: 2 },
      { name: 'LG_Master_Facilitator_Manual_Book3_FINAL.docx', path: '02_FACILITATOR/FM/LG_Master_Facilitator_Manual_Book3_FINAL.docx', requiresBook: 3 },
      { name: 'LG_Master_Facilitator_Manual_Book4_FINAL.docx', path: '02_FACILITATOR/FM/LG_Master_Facilitator_Manual_Book4_FINAL.docx', requiresBook: 4 },
    ],
  },
  {
  ...
  },
  {
    ...
    docs: [
      ...
      { name: 'LG_Outcome_Tracking_Dashboard_Guide.docx', path: '04_OUTCOMES/LG_Outcome_Tracking_Dashboard_Guide.docx' },
